...
#         self.ca = CoordAtt(24, 24, reduction=4)
        ...
        self.scalese1 = Res2Net(inplanes=24, planeslist=[30, 24], scales = [3, 8])
        
        self.scalese2_1 = Res2Net(inplanes=24, planeslist=[30, 24], scales = [3, 8])
        self.scalese2_2 = Res2Net(inplanes=24, planeslist=[30, 24], scales = [3, 8])
        
        self.scalese3_1 = Res2Net(inplanes=24, planeslist=[30, 24], scales = [3, 8])
        self.scalese3_2 = Res2Net(inplanes=24, planeslist=[30, 24], scales = [3, 8])
        self.scalese3_3 = Res2Net(inplanes=24, planeslist=[30, 24], scales = [3, 8])
...
#         scaleca = self.ca(inputs + scaleca1 + scaleca2 + scaleca3)
        scaleca = self.ca(inputs + scaleca1 + scaleca2)
...
#         scalese = self.se(inputs + scalese1 + scalese2)
        
        result = scalese # + scaleca
        return result
