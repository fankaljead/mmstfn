...
class MultiscalFeature_Block(nn.Module):
    def __init__(self, ):
        ...
        self.scaleca1 = Res2Net(inplanes=24)
        
        self.scaleca2_1 = Res2Net(inplanes=24)
        self.scaleca2_2 = Res2Net(inplanes=24)
        
        self.scaleca3_1 = Res2Net(inplanes=24)
        self.scaleca3_2 = Res2Net(inplanes=24)
        self.scaleca3_3 = Res2Net(inplanes=24)
    ...
    def forward(self, inputs):
        ...
        scaleca2 = self.scaleca2_2(scaleca2_1)
        
        scaleca3_1 = self.scaleca3_1(inputs+scaleca1+scaleca2)
        scaleca3_2 = self.scaleca3_2(scaleca3_1)
        scaleca3 = self.scaleca3_3(scaleca3_2)
        ...
        scalese2 = self.scalese2_2(scalese2_1)
        
        scalese3_1 = self.scalese3_1(inputs+scalese1+scalese2)
        scalese3_2 = self.scalese3_2(scalese3_1)
        scalese3 = self.scalese3_3(scalese3_2)
